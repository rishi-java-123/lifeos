...
const links=[['Features','features'],['How it Works','how'],['For Families','family-info'],['Security','security'],['Pricing','pricing']];
export default function PublicHeader({go}){
 ...
 return <header className="publicHeader"><div className="publicHeaderInner">
   <button className="publicBrand" onClick={()=>go('landing')} aria-label="Life OS home"><LifeOSLogo variant="mark" /><b className="brand-text">Life OS</b></button>
